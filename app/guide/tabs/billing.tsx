...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { text: "1 temporary VM (2hr)", included: true },
      { text: "Coasty Computer Agent", included: true },
      { text: "Basic search", included: true },
      { text: "Always-on VMs", included: false },
  ...
  },
  {
    ...
    features: [
      { text: "100 credits/month", included: true },
      { text: "1 always-on VM", included: true },
      { text: "2 agents in parallel", included: true },
      { text: "Basic search", included: true },
      { text: "Standard support (real humans)", included: true },
      { text: "Advanced search & extraction", included: false },
    ],
    cta: "Get Lite",
  },
  {
    ...
    features: [
      ...
      { text: "1 always-on VM", included: true },
      { text: "3 agents in parallel", included: true },
      { text: "Advanced search & extraction", included: true },
      { text: "Standard support (real humans)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "2 always-on VMs", included: true },
      { text: "6 agents in parallel", included: true },
      { text: "Advanced search & extraction", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "3 always-on VMs", included: true },
      { text: "9 agents in parallel", included: true },
      { text: "Advanced search & extraction", included: true },
