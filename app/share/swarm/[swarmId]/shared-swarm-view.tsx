...
// ---------------------------------------------------------------------------
// Strip agent tags (same as swarms-content.tsx)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Tree view — same visual as swarms-content but standalone for the share page
// ---------------------------------------------------------------------------
...
function SharedSwarmTree({
  ...
  return (
    <div className="relative h-full">
      ...
      <div
        ref={containerRef}
        className="relative z-[1] overflow-hidden h-full select-none"
        style={{
