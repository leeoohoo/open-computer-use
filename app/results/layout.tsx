...
export const metadata: Metadata = {
  title: "Case Studies & Results — Watch Coasty AI Agent Work Autonomously",
  ...
  openGraph: {
    title: "Case Studies — Watch Coasty AI Agent Work Autonomously",
    ...
    type: "website",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Coasty AI Agent Case Studies" }],
  },
  twitter: {
