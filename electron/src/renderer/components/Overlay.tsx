              ...
              <div className="mb-1.5 flex items-center justify-center gap-2">
                ...
                {connectionState !== 'connecting' && (
                  <>
                    ...
                    {connectionState === 'error' && (<><span className="text-[10px] text-neutral-600">|</span><button onClick={() => signOut()} className="text-[10px] font-medium text-red-400 hover:text-red-300 transition-colors">Sign in again</button></>)}
                  </>
                )}
              </div>
            )}
